...
const ProjectCard = ({ project, index }: { project: any; index: any }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-bg-color max-w-[400px] p-2 sm:p-3 border-1 border-gray-1 rounded-3xl hover:border-primary project__box h-full`}
      >
        ...
        <div className="flex flex-col justify-between  mt-2 md:mt-5">
          <div>
            <a
