    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center items-center order-2 md:order-1">
          <div className="max-w-[400px] text-center animate__animated animate__fadeInLeft">
        ...
        <div className="h-full w-full flex items-center justify-between animate__animated animate__fadeInRight  order-1 md:order-2">
